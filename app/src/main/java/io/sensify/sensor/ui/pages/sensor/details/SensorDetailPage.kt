...
import io.sensify.sensor.ui.pages.sensor.details.sections.SensorDetailCurrentValue
import io.sensify.sensor.ui.pages.sensor.details.sections.SensorDetailHeader
...
@Composable
fun SensorDetailPage(modifier: Modifier = Modifier, navController: NavController? = null) {
